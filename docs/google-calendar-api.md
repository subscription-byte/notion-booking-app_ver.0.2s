...
| 2 | セージ | #33B679 | rgb(51, 182, 121) | **PersonA LINE連携予約** |
...
| 11 | トマト | #D50000 | rgb(213, 0, 0) | **PersonC LINE連携予約** |

### このプロジェクトでの色分けルール

- **colorId '7' (ピーコック・水色)**: 通常リンクからの予約（X DM経由）
- **colorId '2' (セージ・緑)**: PersonA（LINE連携）からの予約
- **colorId '11' (トマト・赤)**: PersonC（LINE連携）からの予約
